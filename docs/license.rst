...
2. Redistributions in binary form must reproduce the above in the documentation and/or other materials provided with the distribution.

.. note::
   The BSD 2-Clause license does **not** permit the use of the names of the project or its contributors for endorsement without permission.  
   If you need more flexibility in branding or want to discuss licensing options, please reach out.
