...
from .models import multi_trial_BIC
from .utils.core import extract_event_snapshots, compute_event_statistics
from .utils.preprocess import remove_artifact_trials
from .causality import time_varying_causality


def snapshot_detect_analysis_pipeline(OriSignal: np.ndarray, DetSignal: np.ndarray, Params: Dict) -> Tuple[Dict, Dict, np.ndarray]:
    SnapAnalyOutput = {}
